...
class AgeGender(DataGardenSubModel):
	male: dict[str, int] = Field(default_factory=dict, description=L.AGE_GENDER_MALE)
	female: dict[str, int] = Field(default_factory=dict, description=L.AGE_GENDER_FEMALE)
